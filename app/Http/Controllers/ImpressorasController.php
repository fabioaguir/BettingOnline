...
use Softage\Validators\ImpressorasValidator;
...
class ImpressorasController extends Controller
{
    ...
    /**
     * @var ImpressorasService
     */
    private $service;

    /**
     * @var ImpressorasValidator
     */
    private $validator;
    ...
    public function __construct(ImpressorasService $service, ImpressorasValidator $validator)
    {
    ...
    {
        #Criando a consulta
        $rows = \DB::table('impressoras')->select(['id', 'nome']);
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('impressoras.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            #retorno para view
            return view('impressoras.edit', compact('model', 'loadFields'));
