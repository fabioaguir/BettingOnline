...
class ReportVendasPremiadasController extends Controller
{
    ...
    public function view()
    {
        ...
        #Retorno para view
        return view('reports.reportVendasPremiadas', compact('loadFields'));
    }
    ...
    public function pdfVendas(Request $request)
    {
        ...
        if($dados['exportar'] == '1') {
            ...
            return \PDF::loadView('reports.reportVendasPremiadasPDF', ['vendas' => $vendas->get(), 'sum' => $sum])->stream();
            ...
            \Excel::create('Relatório de vendas', function($excel) {
                ...
                $excel->sheet('Excel', function($sheet) {
                    ...
                    $sheet->loadView('reports.reportVendasPremiadasExcel', array('vendas' => $this->queryVendas, 'sum' => $this->querySum));
