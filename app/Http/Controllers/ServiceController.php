...
use Softage\Services\ServiceService;
...
class ServiceController extends Controller
{
    ...
    */
    public function __construct(ServiceService $service, ServiceValidator $validator)
    {
    ...
    {
        #Criando a consulta
        $rows = \DB::table('service')->select(['id', 'sev_name as name','sev_amount as value']);
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('service.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
           ...
           // $aluno = $this->service->getAlunoWithDateFormatPtBr($aluno);
            ...
            #retorno para view
            return view('service.edit', compact('model', 'loadFields'));
