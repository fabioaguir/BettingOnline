...
{
    /**
     * @var TabletsRepository
     */
    private $repository;

    /**
     * @param TabletsRepository $repository
     */
    public function __construct(TabletsRepository $repository)
    {
     ...
     * @return array
     */
    public function store(array $data) : Tablets
    {
     ...
     * @return mixed
     */
    public function update(array $data, int $id) : Tablets
    {
