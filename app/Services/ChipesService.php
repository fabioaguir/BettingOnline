...
{
    /**
     * @var ChipesRepository
     */
    private $repository;

    /**
     * @param ChipesRepository $repository
     */
    public function __construct(ChipesRepository $repository)
    {
     ...
     * @return array
     */
    public function store(array $data) : Chipes
    {
     ...
     * @return mixed
     */
    public function update(array $data, int $id) : Chipes
    {
