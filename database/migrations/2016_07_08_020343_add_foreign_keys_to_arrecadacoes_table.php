...
class AddForeignKeysToArrecadacoesTable extends Migration {
	...
	public function up()
	{
		Schema::table('arrecadacoes', function(Blueprint $table)
		{
			...
			$table->foreign('vendedor_id', 'fk_arrecadacoes_pessoas2')->references('id')->on('pessoas')->onUpdate('NO ACTION')->onDelete('NO ACTION');
		});
	}
	...
	public function down()
	{
		Schema::table('arrecadacoes', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_arrecadacoes_pessoas2');
		});
	}
