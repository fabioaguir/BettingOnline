...
@section('content')
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            {!! Form::open(['route'=>'seracademico.alunos.update', 'method' => "POST", 'id' => 'formAluno', 'enctype' => 'multipart/form-data']) !!}
                @include('tamplatesForms.tamplateFormAluno')
                <a href="{{ route('seracademico.report.contratoAluno', ['id' => $cliente['id']]) }}" target="_blank" class="btn btn-info">Contrato</a>
            {!! Form::close() !!}
        </div>
    </div>
