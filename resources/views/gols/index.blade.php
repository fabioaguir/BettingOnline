                ...
                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-md-offset-1">
                                <div class="table-responsive no-padding">
                                    <table id="resultado-grid" class="table table-bordered" cellspacing="0" >
                                        <thead>
                                        <tr>
                                            <th style="text-align: center; border-color: #639657; font-size: 16px; color: #fff; background-color: #74a768">RESULTADO</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                            <td colspan="3" style="text-align: center; font-size: 16px; font-weight: bold; background-color: #d7e6d4">Sport 10 x 0 Santa Cruz</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive no-padding">
                                    <table id="gols-grid" class="display table table-bordered" cellspacing="0"
                                           width="100%">
                                        <thead>
                                        <tr>
                                            <th>Tempo</th>
