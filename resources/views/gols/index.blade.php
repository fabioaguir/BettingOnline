                            ...
                            <div class="col-md-4 col-md-offset-1">
                                <div class="table-responsive no-padding">
                                    <table id="resultado-grid" class="display table table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                        <tr>
                                            <th style="text-align: center; color: #fff; border-color:  #73a869;font-size: 16px; background-color: #91ba89">RESULTADO</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                            <td colspan="3" style="text-align: center; font-size: 16px; font-weight: bold; background-color: #d7e6d4">
